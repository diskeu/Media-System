            ...
            <tr>
                <td align="center" style="padding: 20px 0;">
                    <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color:#ffffff; border-radius:8px; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.1);">
                        ...
                        <!-- Header -->
                        <tr>
                            <td style="padding:20px; text-align:center; background-color:#dc3545; color:#ffffff; font-size:24px; font-weight:bold;">
                                Media-System
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="padding:30px; color:#333333; font-size:16px; line-height:1.5;">
                                ...
                                <p>
                                    We received a request to reset your Media-System account password.
                                    If this was not you, you can safely ignore this email or contact
                                    <a href="mailto:support@media_system.com" style="color:#dc3545; text-decoration:none;" target="_blank">
                                        support@media_system.com
                                    </a>.
                                </p>
                                ...
                                <!-- Button -->
                                <p style="text-align:center; margin:30px 0;">
                                    <a href="https://deine-seite.com/reset-password?token={token}" 
                                       style="display:inline-block; padding:14px 28px; font-size:16px; font-weight:bold; color:#ffffff; background-color:#dc3545; text-decoration:none; border-radius:6px; border:1px solid #dc3545;"
                                       target="_blank" 
                                       aria-label="Reset your Media-System password">
                                        Reset Password
                                    </a>
                                </p>
